...
class Artist(db.Model):
    ...
    seeking_venue = db.Column(db.String, default='OFF')
...
class Venue(db.Model):
    ...
    venue_price = db.Column(db.Integer, nullable=False)
...
class Show(db.Model):
    ...
    tickets = db.relationship('Ticket', backref='shows', lazy=True)
...
class Ticket(db.Model):
    ...
    fan_id = db.Column(db.Integer, db.ForeignKey('fan.fan_id'))
